...
// Pneumatics
#define GPIO_PRIM_GRIP_PORT     GPIOB
#define GPIO_PRIM_GRIP_PIN		GPIO_Pin_13
#define GPIO_SEC_GRIP_PORT		GPIOB
#define GPIO_SEC_GRIP_PIN		GPIO_Pin_14
#define GPIO_SHOT_PIN_CYL_PORT  GPIOB
#define GPIO_SHOT_PIN_CYL_PIN   GPIO_Pin_15
