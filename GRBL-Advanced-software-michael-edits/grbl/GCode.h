...
#define MODAL_GROUP_M101    15  // [M101,M102] Primary Gripper
#define MODAL_GROUP_M103    15  // [M103,M104] Secondary Gripper
#define MODAL_GROUP_M105    15  // [M105,M106] Shot Pin
...
// Modal Group M101, M103, M105: Pneumatics
#define RETRACT                             0
#define EXTEND                              1
...
typedef struct {
	...
	uint8_t prim_grip;       // {M101, M102}
	uint8_t sec_grip;        // {M103, M104}
	uint8_t shot_pin;        // {M105, M106}
